...
if (!function_exists('skeleton_scripts')) {
     ...
     function skeleton_scripts() {
          ...
          wp_enqueue_style('genericons', trailingslashit(get_template_directory_uri()) . '/css/genericons.css', array(), $version, 'screen, projection');
...
if (!function_exists('skeleton_setup')):
     ...
     function skeleton_setup() {
          ...
          register_nav_menus(array(
              ...
              'social' => __('Social Navigation', 'smpl'),
...
if (!function_exists('skeleton_main_menu')) {
     ...
     function skeleton_main_menu() {
          echo '<div id="navigation" class="row sixteen columns"><span id="menuBtn"><p class="screen-reader-text">Menu</p></span>';
          wp_nav_menu(array('container_class' => 'menu-header', 'theme_location' => 'primary'));
          smpl_social_navigation();
          echo '</div><!--/#navigation-->';
     }
...
if (!function_exists('skeleton_comments')) :
     ...
     if (!function_exists('skeleton_posted_on')) :
          ...
          function skeleton_posted_on() {
               printf(__('<span class="%1$s">Posted on</span> %2$s <span class="meta-sep">by</span> %3$s', 'smpl'), 'meta-prep meta-prep-author', sprintf('<a href="%1$s" title="%2$s" rel="bookmark"><span class="entry-date">%3$s</span></a>', get_permalink(), esc_attr(get_the_time()), get_the_date()
                       ), sprintf('<span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>', get_author_posts_url(get_the_author_meta('ID')), sprintf(esc_attr__('View all posts by %s', 'smpl'), get_the_author()), get_the_author()
                       )
               );
          }
