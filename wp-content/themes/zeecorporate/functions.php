...
function themezee_enqueue_scripts() { 
	...
	wp_register_style('zeeCorporate_stylesheet', get_stylesheet_uri());
	wp_enqueue_style('zeeCorporate_stylesheet');
...
function themezee_credit_link() { ?>
	<a href="http://themezee.com/themes/zeecorporate/"><?php _e('zeeCorporate Theme', 'themezee_lang'); ?></a>
<?php
}
...
<?php 
	...
	if (get_the_tags()) echo ' | '; the_tags(__('Tags: ', 'themezee_lang'), ', ');
